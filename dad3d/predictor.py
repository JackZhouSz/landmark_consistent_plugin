...
class FaceMeshPredictor:
    def __init__(self, config: Dict[str, Any], cuda_id: int = 0):
        ...
        print ( os.path.join(os.path.expanduser('~'), config["model_path"]) )
    ...
    def __call__(self, x: Any) -> Any:
        ...
        # torch.save(state_dict, '/nfs/home/uss00054/.dad_checkpoints/dad_3dheads.ckpt')
        # state_dict = torch.load('/nfs/home/uss00054/.dad_checkpoints/dad_3dheads.ckpt')
        # my_dict = {key: torch.zeros_like(state_dict['state_dict'][key]) for key in state_dict['state_dict']}
        # self.model.load_state_dict(my_dict)
    ...
    @classmethod
    def dad_3dnet(cls, model_path=None):
