...
class FlameDataset(Dataset):
    ...
    def _project_vertices_onto_image(
        ...
        # print('========_project_vertices_onto_image=========vertices3d_world_homo.shape:{}\n'.format(vertices3d_world_homo.shape))
        # print('========_project_vertices_onto_image=========projection_matrix.shape:{}\n'.format(projection_matrix.shape))
        # print('========_project_vertices_onto_image=========height:{}\n'.format(height))
        # print('========_project_vertices_onto_image=========crop_point_x:{}\n'.format(crop_point_x))
        # print('========_project_vertices_onto_image=========crop_point_y:{}\n'.format(crop_point_y))
        vertices2d_homo = np.transpose(np.matmul(projection_matrix, np.transpose(vertices3d_world_homo)))
        # print('========_project_vertices_onto_image=========vertices2d_homo[0]:{}\n'.format(vertices2d_homo[0]))
    ...
    def _get_2d_landmarks_w_presence(
        ...
        # print('========_get_2d_landmarks_w_presence=========len_self.keypoints_indices:{}\n'.format(len(self.keypoints_indices)))
        # print('========_get_2d_landmarks_w_presence=========self.keypoints_indices:\n{}\n'.format(self.keypoints_indices))
        # print('========_get_2d_landmarks_w_presence=========landmarks_3d_world_subset:\n{}\n'.format(landmarks_3d_world_subset))
        # print('========_get_2d_landmarks_w_presence=========projection_matrix:\n{}\n'.format(projection_matrix))
        # print('========_get_2d_landmarks_w_presence=========img_shape:{}\n'.format(img_shape))
        # print('========_get_2d_landmarks_w_presence=========bbox:{}\n'.format(bbox))
        # print('========_get_2d_landmarks_w_presence=========landmarks_2d_subset:\n{}\n'.format(landmarks_2d_subset))
        # print('========_get_2d_landmarks_w_presence=========presence_subset:\n{}\n'.format(presence_subset))
