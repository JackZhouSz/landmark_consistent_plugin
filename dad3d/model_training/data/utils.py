...
def get_static_lmks(
    ...
    # print (lmk_faces_idx.shape, 'lmk_faces_idx')
    # print (lmk_faces_idx,'********************')
    # print (lmk_bary_coords.shape, 'lmk_bary_coords')
    # print ('----------------------------------------')
...
def get_dynamic_lmks(
    ...
    # print (dynamic_lmk_faces_idx.shape, 'dynamic_lmk_faces_idx')
    # print ('++++++++')
    # print (dynamic_lmk_faces_idx[0])
    # print (dynamic_lmk_faces_idx[1])
    # print (dynamic_lmk_faces_idx[11])
    # print (dynamic_lmk_faces_idx[21])
    # print ('++++++++')
    # print (dynamic_lmk_bary_coords.shape, 'dynamic_lmk_bary_coords')
    # print ('================================================')
    ...
    # print (mesh_vertices.shape, 'mesh_vertices')
    # print (mesh_faces.shape, 'mesh_faces')
    # print (dyn_lmk_faces_idx[0].shape,'dyn_lmk_faces_idx[0]')
    # print (dyn_lmk_bary_coords[0].shape, 'dyn_lmk_bary_coords[0]')
...
def get_68_landmarks(
    ...
    # print (static_lmks.shape, 'static_lmks')
    dynamic_lmks = get_dynamic_lmks(mesh_vertices, mesh_faces)
    # print (dynamic_lmks.shape, 'dynamic_lmks')
    # print ('!!!!!!!!!!!!!!!!!!!!!')
    # return static_lmks
